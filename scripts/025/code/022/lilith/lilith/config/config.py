...
import openai
import yaml
from auto_gpt_plugin_template import LilithPluginTemplate
from colorama import Fore
from dotenv import load_dotenv

from lilith.config.singleton import Singleton
...
class Config(metaclass=Singleton):
    ...
    def __init__(self) -> None:
        ...
        self.milvus_collection = os.getenv("MILVUS_COLLECTION", "lilith")
        ...
        self.plugins: List[LilithPluginTemplate] = []
        self.plugins_openai = []
